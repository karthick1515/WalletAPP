...
public class TransactionController {
    ...
    @PutMapping("/update")
    public ResponseEntity<Transaction> updateTransaction(@RequestBody Transaction transaction) throws NotFoundException {
    ...
    public ResponseEntity<Transaction> getTransactionById(@RequestParam Long transactionId) throws NotFoundException {
    ...
    public ResponseEntity<List<Transaction>> getAllTransactionsByWalletAccountId(@RequestParam Long walletAccountId) throws NotFoundException {
    ...
    public ResponseEntity<Transaction> addMoneyFromBank(@RequestBody AddMoneyRequest addMoneyRequest) throws InvalidAccountIdException, AuthenticationFailedException, InvalidAmountException {
